        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">Aggregator Instances</div>
                    <div class="panel-body">
                        <a href="{{ url('/admin/aggregator-instances/create') }}" class="btn btn-success btn-sm" title="Add New AggregatorInstance">
                            <i class="fa fa-plus" aria-hidden="true"></i> Add New
                        </a>

                        {!! Form::open(['method' => 'GET', 'url' => '/admin/aggregator-instances', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                ...
                                @foreach($aggregatorinstances as $item)
                                    <tr>
                                        <td>{{ $item->id }}</td>
                                        <td>{{ $item->type }}</td><td>{{ $item->resource }}</td>
                                        <td>
                                            ...
                                            {!! Form::open([
                                                'method'=>'DELETE',
                                                'url' => ['/admin/aggregator-instances', $item->id],
                            ...
                            <div class="pagination-wrapper"> {!! $aggregatorinstances->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
