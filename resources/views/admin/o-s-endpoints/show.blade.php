        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-heading">OSEndpoint {{ $osendpoint->id }}</div>
                    <div class="panel-body">
                        ...
                        <a href="{{ url('/admin/o-s-endpoints/' . $osendpoint->id . '/edit') }}" title="Edit OSEndpoint"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        {!! Form::open([
                            'method'=>'DELETE',
                            'url' => ['admin/osendpoints', $osendpoint->id],
